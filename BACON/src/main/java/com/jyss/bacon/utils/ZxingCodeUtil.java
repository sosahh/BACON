...
public class ZxingCodeUtil {
	 ...
	 *            二维码生成格式
	 */
	public static void zxingCodeCreate(String orderSn, String outPutPath,
			String type) {
		String text = "orderSn=" + orderSn + ";" + "type=" + type;
		int width = 330;
		int height = 330;
		// String outPutPath = "c://" + orderSn + ".png";
	...
	public static void main(String[] args) throws Exception {
		...
		zxingCodeCreate("154679333+641", "c://" + 1333331 + ".png", "1");
