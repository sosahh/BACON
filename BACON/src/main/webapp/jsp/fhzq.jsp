...
<html>
	...
	<body class="easyui-layout">
		<table id="zqDg" title="返还周期列表" class="easyui-datagrid" style="width:1750px;height:865px"
			url="getClsBy.action?bz_type=fhzq_type"
			...
			<thead>
				<tr>
					...
					<th field="bz_value" width="150">对应数值</th>
