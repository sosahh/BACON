...
<html>
    ...
    function addscWin(){
    	$("#scDg").datagrid("uncheckAll");         
        $( "#addsc" ).window("open").window("setTitle", "修改");
        // $( "#addCl" ).window("open"); 
      }
    function closescWin(){
         $( "#addsc" ).window("close");
	...
	<body class="easyui-layout">
		<table id="scDg" title="比例详情列表" class="easyui-datagrid" style="width:1750px;height:865px"
			url="getClsBy.action?bz_type=scj_type"
       ...
       <div id="addsc" class="easyui-window" title="修改数值"  closed = "true" style="width:450px;height:250px;">
			 <form method="post" id="scFm" text-align:center>
				...
				<div style="padding:5px;text-align:center;">
					<a href="#" class="easyui-linkbutton" icon="icon-ok" onclick="savesc()">保存</a>&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="#" class="easyui-linkbutton" icon="icon-cancel"  onclick="closescWin()">取消</a>
				</div>
			</form>
	  </div>	  
	<style>
