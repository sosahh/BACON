...
<html>
    ...
    function addpvWin(){
    	$("#pvDg").datagrid("uncheckAll");         
        $( "#addpv" ).window("open").window("setTitle", "修改");
        // $( "#addCl" ).window("open"); 
      }
    function closepvWin(){
         $( "#addpv" ).window("close");
	...
	<body class="easyui-layout">
		<table id="pvDg" title="pv列表" class="easyui-datagrid" style="width:1750px;height:865px"
			url="getClsBy.action?bz_type=pv_type"
			...
			<thead>
				<tr>
					...
					<th field="bz_info" width="200">对应标识</th>
       ...
       <div id="addpv" class="easyui-window" title="修改数值"  closed = "true" style="width:450px;height:250px;">
			 <form method="post" id="pvFm" text-align:center>
				...
				<div style="padding:5px;text-align:center;">
					<a href="#" class="easyui-linkbutton" icon="icon-ok" onclick="savepv()">保存</a>&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="#" class="easyui-linkbutton" icon="icon-cancel"  onclick="closepvWin()">取消</a>
				</div>
			</form>
	  </div>	  
	<style>
