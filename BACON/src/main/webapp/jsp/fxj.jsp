...
<html>
    ...
    function addfxWin(){
    	$("#fxDg").datagrid("uncheckAll");         
        $( "#addfx" ).window("open").window("setTitle", "修改");
        // $( "#addCl" ).window("open"); 
      }
    function closefxWin(){
         $( "#addfx" ).window("close");
	...
	<body class="easyui-layout">
		<table id="fxDg" title="分销奖比例详情列表" class="easyui-datagrid" style="width:1750px;height:865px"
			url="getClsBy.action?bz_type=fxj_type"
       ...
       <div id="addfx" class="easyui-window" title="修改数值"  closed = "true" style="width:450px;height:250px;">
			 <form method="post" id="fxFm" text-align:center>
				...
				<div style="padding:5px;text-align:center;">
					<a href="#" class="easyui-linkbutton" icon="icon-ok" onclick="savefx()">保存</a>&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="#" class="easyui-linkbutton" icon="icon-cancel"  onclick="closefxWin()">取消</a>
				</div>
			</form>
	  </div>	  
	<style>
