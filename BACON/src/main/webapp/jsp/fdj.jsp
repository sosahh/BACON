...
<html>
    ...
    function addfdjWin(){
    	$("#fdjDg").datagrid("uncheckAll");         
        $( "#addfdj" ).window("open").window("setTitle", "修改");
        // $( "#addCl" ).window("open"); 
      }
    function closefdjWin(){
         $( "#addfdj" ).window("close");
         $("#fdjFm").form("clear"); 
      }
	...
	<body class="easyui-layout">
		<table id="fdjDg" title="分销奖比例详情列表" class="easyui-datagrid" style="width:1750px;height:865px"
			url="getClsBy.action?bz_type=fdj_type"
       ...
       <div id="addfdj" class="easyui-window" title="修改数值"  closed = "true" style="width:450px;height:250px;">
			 <form method="post" id="fdjFm" text-align:center>
				...
				<div style="padding:5px;text-align:center;">
					<a href="#" class="easyui-linkbutton" icon="icon-ok" onclick="savefdj()">保存</a>&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="#" class="easyui-linkbutton" icon="icon-cancel"  onclick="closefdjWin()">取消</a>
				</div>
			</form>
	  </div>	  
	<style>
