...
<html>
    ...
    function addglWin(){
    	$("#glDg").datagrid("uncheckAll");         
        $( "#addgl" ).window("open").window("setTitle", "修改");
        // $( "#addCl" ).window("open"); 
      }
    function closeglWin(){
         $( "#addgl" ).window("close");
	...
	<body class="easyui-layout">
		<table id="glDg" title="分销奖比例详情列表" class="easyui-datagrid" style="width:1750px;height:865px"
			url="getClsBy.action?bz_type=glj_type"
			...
			<thead>
				<tr>
					...
					<th field="bz_info" width="200">相应金额</th>
       ...
       <div id="addgl" class="easyui-window" title="修改数值"  closed = "true" style="width:450px;height:250px;">
			 <form method="post" id="glFm" text-align:center>
				...
				<div style="padding:5px;text-align:center;">
					<a href="#" class="easyui-linkbutton" icon="icon-ok" onclick="savegl()">保存</a>&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="#" class="easyui-linkbutton" icon="icon-cancel"  onclick="closeglWin()">取消</a>
				</div>
			</form>
	  </div>	  
	<style>
